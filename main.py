...
from kivymd.uix.behaviors import (
    CommonElevationBehavior,  # للظلال والارتفاع
    BackgroundColorBehavior  # للتحكم في الخلفيات
)
...
#class CustomThreeLineItem(MDListItem):
#    def __init__(self, primary_text="", secondary_text="", tertiary_text="", **kwargs):
#        super().__init__(**kwargs)
#
#        # إعداد النص الرئيسي
#        self.headline = MDListItemHeadlineText(
#            text=primary_text,
#            font_name="Amiri-Regular.ttf",
#            font_size=sp(15),
#            theme_text_color="Custom",
#            text_color=(1, 1, 1, 1),  # أبيض
#        )
#
#        # إعداد النص الثانوي
#        self.secondary = MDListItemSupportingText(
#            text=secondary_text,
#            font_name="Amiri-Regular.ttf",
#            font_size=sp(15),
#            theme_text_color="Custom",
#            text_color=(0, 1, 1, 1),  # سماوي
#        )
#
#        # إعداد النص الثالث
#        self.tertiary = MDListItemSupportingText(
#            text=tertiary_text,
#            font_name="Amiri-Regular.ttf",
#            font_size=sp(15),
#            theme_text_color="Custom",
#            text_color=(0.7, 0.7, 0.7, 1),  # رمادي فاتح
#        )
#
#        # حاوية داخلية لترتيب النصوص عموديًا
#        self.text_box = BoxLayout(orientation="vertical", spacing=2, padding=(8, 4))
#        self.text_box.add_widget(self.headline)
#        self.text_box.add_widget(self.secondary)
#        self.text_box.add_widget(self.tertiary)
#
#        self.add_widget(self.text_box)
#
#        # لون خلفية العنصر (اختياري)
#        self.theme_bg_color = "Custom"
#        self.md_bg_color = (0.1, 0.1, 0.1, 1)  # خلفية داكنة
...
def create_button_dictionary(text, on_press_action):
    button = MDButton(
        style="tonal",  # أو "text", "elevated", "filled" حسب التصميم الذي تريده
        size_hint=(0.5, 0.1),
