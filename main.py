...
class CustomListItem(MDListItem):
    def __init__(self, **kwargs):
        ...
        self.headline = MDListItemHeadlineText(
            ...
            text_color=(1, 1, 1, 1),  # اللون الأبيض
            size_hint_x=5,
            font_size="15sp"
        )
        ...
        self.secondary = MDListItemSupportingText(
            font_name="Amiri-Regular.ttf",
            theme_text_color="Custom",
            text_color=(0, 1, 1, 1),  # اللون السماوي
            size_hint_x=5,
            font_size="15sp"
        )
        ...
        self.add_widget(self.tertiary)

        # إعداد المواقع
        self.headline.pos_hint = {"center_x": 2.48, "center_y": 1}
        self.secondary.pos_hint = {"center_x": 2.48, "center_y": 1}
        self.tertiary.pos_hint = {"center_x": 2.48, "center_y": 1}

        # لون الفاصل
        self.divider_color = (0.15, 0.22, 0.35, 1)

    # دالة لتعيين النصوص
    def set_text(self, primary, secondary, tertiary=""):
        self.headline.text = primary
        self.secondary.text = secondary
        self.tertiary.text = tertiary
...
def create_button_dictionary(text, on_press_action):
    button = MDButtonText(text=fix_arabic_text(text), font_name="Amiri-Regular.ttf", size_hint=(0.5, 0.1), pos_hint= {"center_x": 0.5, "center_y": 0.5})
